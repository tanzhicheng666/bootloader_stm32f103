 ...
 *  All rights reserved
 *
 *  File name: algo_crc.c
 *  Description: Algorithm layer — CRC-16/MODBUS implementation
 ...
 * Polynomial: 0x8005, Reflected: true
 *============================================================================*/
...
/*==============================================================================
 *  Function: uint16_t algo_crc16(const uint8_t *data, uint16_t len)
